...
function BottomCTA() {
    return (
        <section className="py-96 bg-black relative overflow-hidden flex flex-col items-center justify-center border-t border-white/5">
                ...
                >
                    ...
                    <div className="flex flex-col md:flex-row gap-8 justify-center items-center w-full">
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="group relative px-16 py-8 bg-[#a8ffc4] text-black font-bold text-2xl rounded-full overflow-hidden shadow-[0_0_40px_rgba(168,255,196,0.4)]"
                        >
                        ...
                        <motion.button
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="px-16 py-8 bg-white/5 border border-white/10 text-white font-bold text-2xl rounded-full hover:bg-white/10 hover:border-[#a8ffc4]/30 transition-all focus:outline-none focus:ring-2 focus:ring-[#a8ffc4]/50"
                        >
                            View Case Studies
                        </motion.button>
                    </div>
...
function FAQSection() {
    ...
    return (
        <section className="py-96 bg-black relative flex flex-col justify-center items-center overflow-hidden border-t border-white/5">
            {/* Spacer Line - Extended */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-px h-64 bg-gradient-to-b from-[#a8ffc4]/30 to-transparent" />

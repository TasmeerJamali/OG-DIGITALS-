...
const team: {
    ...
    id: "02",
    keywords: ["STRATEGY", "SALES", "GROWTH"],
    desc: "Turning prospects into partners and pipelines into revenue streams.",
    color: "#60a5fa",
    warning: "WARNING: SALES TARGET EXCEEDED. PIPELINE CRITICALLY FULL.",
    success: "STATUS: DEALS CLOSED. REVENUE OVERFLOWING. GROWTH UNSTOPPABLE.",
    image: "/assets/team/faiqyasser.jpeg",
